...
void menuOptions(char choice, DoublyLinkedList& dll)
{
	...
	{
		case 'a':
			std::cout << "load inventory file"<<std::endl;
			inventoryLoader(dll);
			break;
		case 'b':
